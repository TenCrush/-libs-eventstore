...
<dl class="details">
    ...
    <h4 class="name" id="appendToStream"><span class="type-signature"></span>appendToStream<span class="signature">(stream, expectedVersion, events, userCredentials<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise.&lt;<a href="WriteResult.html">WriteResult</a>>}</span></h4>
...
<dl class="details">
    ...
    <h4 class="name" id="commitTransaction"><span class="type-signature"></span>commitTransaction<span class="signature">(transaction, userCredentials)</span><span class="type-signature"> &rarr; {Promise.&lt;<a href="WriteResult.html">WriteResult</a>>}</span></h4>
...
<span class="param-type">Promise.&lt;<a href="WriteResult.html">WriteResult</a>></span>
    ...
    <h4 class="name" id="connect"><span class="type-signature"></span>connect<span class="signature">()</span><span class="type-signature"> &rarr; {Promise}</span></h4>
...
<span class="param-type">Promise.&lt;EventStorePersistentSubscription></span>
    ...
    <h4 class="name" id="continueTransaction"><span class="type-signature"></span>continueTransaction<span class="signature">(transactionId, userCredentials)</span><span class="type-signature"> &rarr; {<a href="EventStoreTransaction.html">EventStoreTransaction</a>}</span></h4>
...
<span class="param-type"><a href="EventStoreTransaction.html">EventStoreTransaction</a></span>
    ...
    <h4 class="name" id="createPersistentSubscription"><span class="type-signature"></span>createPersistentSubscription<span class="signature">(stream, groupName, settings, userCredentials<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise.&lt;<a href="PersistentSubscriptionCreateResult.html">PersistentSubscriptionCreateResult</a>>}</span></h4>
...
<span class="param-type">Promise.&lt;<a href="PersistentSubscriptionCreateResult.html">PersistentSubscriptionCreateResult</a>></span>
    ...
    <h4 class="name" id="deletePersistentSubscription"><span class="type-signature"></span>deletePersistentSubscription<span class="signature">(stream, groupName, userCredentials<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise.&lt;<a href="PersistentSubscriptionDeleteResult.html">PersistentSubscriptionDeleteResult</a>>}</span></h4>
...
<span class="param-type">Promise.&lt;<a href="PersistentSubscriptionDeleteResult.html">PersistentSubscriptionDeleteResult</a>></span>
    ...
    <h4 class="name" id="deleteStream"><span class="type-signature"></span>deleteStream<span class="signature">(stream, expectedVersion, hardDelete<span class="signature-attributes">opt</span>, userCredentials<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise.&lt;<a href="DeleteResult.html">DeleteResult</a>>}</span></h4>
...
<span class="param-type">Promise.&lt;<a href="DeleteResult.html">DeleteResult</a>></span>
    ...
    <h4 class="name" id="getStreamMetadataRaw"><span class="type-signature"></span>getStreamMetadataRaw<span class="signature">(stream, userCredentials<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise.&lt;<a href="RawStreamMetadataResult.html">RawStreamMetadataResult</a>>}</span></h4>
...
<span class="param-type">Promise.&lt;<a href="RawStreamMetadataResult.html">RawStreamMetadataResult</a>></span>
    ...
    <h4 class="name" id="readAllEventsBackward"><span class="type-signature"></span>readAllEventsBackward<span class="signature">(position, maxCount, resolveLinkTos<span class="signature-attributes">opt</span>, userCredentials<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise.&lt;<a href="AllEventsSlice.html">AllEventsSlice</a>>}</span></h4>
...
<span class="param-type">Promise.&lt;<a href="AllEventsSlice.html">AllEventsSlice</a>></span>
    ...
    <h4 class="name" id="readAllEventsForward"><span class="type-signature"></span>readAllEventsForward<span class="signature">(position, maxCount, resolveLinkTos<span class="signature-attributes">opt</span>, userCredentials<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise.&lt;<a href="AllEventsSlice.html">AllEventsSlice</a>>}</span></h4>
...
<span class="param-type">Promise.&lt;<a href="AllEventsSlice.html">AllEventsSlice</a>></span>
    ...
    <h4 class="name" id="readEvent"><span class="type-signature"></span>readEvent<span class="signature">(stream, eventNumber, resolveLinkTos<span class="signature-attributes">opt</span>, userCredentials<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise.&lt;<a href="EventReadResult.html">EventReadResult</a>>}</span></h4>
...
<span class="param-type">Promise.&lt;<a href="EventReadResult.html">EventReadResult</a>></span>
    ...
    <h4 class="name" id="readStreamEventsBackward"><span class="type-signature"></span>readStreamEventsBackward<span class="signature">(stream, start, count, resolveLinkTos<span class="signature-attributes">opt</span>, userCredentials<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise.&lt;<a href="StreamEventsSlice.html">StreamEventsSlice</a>>}</span></h4>
...
<span class="param-type">Promise.&lt;<a href="StreamEventsSlice.html">StreamEventsSlice</a>></span>
    ...
    <h4 class="name" id="setStreamMetadataRaw"><span class="type-signature"></span>setStreamMetadataRaw<span class="signature">(stream, expectedMetastreamVersion, metadata, userCredentials<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise.&lt;<a href="WriteResult.html">WriteResult</a>>}</span></h4>
...
<span class="param-type">Promise.&lt;<a href="WriteResult.html">WriteResult</a>></span>
    ...
    <h4 class="name" id="startTransaction"><span class="type-signature"></span>startTransaction<span class="signature">(stream, expectedVersion, userCredentials<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise.&lt;<a href="EventStoreTransaction.html">EventStoreTransaction</a>>}</span></h4>
...
<span class="param-type">Promise.&lt;<a href="EventStoreTransaction.html">EventStoreTransaction</a>></span>
    ...
    <h4 class="name" id="subscribeToAll"><span class="type-signature"></span>subscribeToAll<span class="signature">(resolveLinkTos<span class="signature-attributes">non-null</span>, eventAppeared<span class="signature-attributes">non-null</span>, subscriptionDropped<span class="signature-attributes">opt</span>, userCredentials<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise.&lt;<a href="EventStoreSubscription.html">EventStoreSubscription</a>>}</span></h4>
...
<span class="param-type">Promise.&lt;<a href="EventStoreSubscription.html">EventStoreSubscription</a>></span>
    ...
    <h4 class="name" id="subscribeToAllFrom"><span class="type-signature"></span>subscribeToAllFrom<span class="signature">(lastCheckpoint<span class="signature-attributes">nullable</span>, resolveLinkTos<span class="signature-attributes">non-null</span>, eventAppeared<span class="signature-attributes">non-null</span>, liveProcessingStarted<span class="signature-attributes">opt</span>, subscriptionDropped<span class="signature-attributes">opt</span>, userCredentials<span class="signature-attributes">opt</span>, readBatchSize<span class="signature-attributes">opt, non-null</span>)</span><span class="type-signature"> &rarr; {EventStoreAllCatchUpSubscription}</span></h4>
...
<span class="param-type">EventStoreAllCatchUpSubscription</span>
    ...
    <h4 class="name" id="subscribeToStream"><span class="type-signature"></span>subscribeToStream<span class="signature">(stream<span class="signature-attributes">non-null</span>, resolveLinkTos<span class="signature-attributes">non-null</span>, eventAppeared, subscriptionDropped<span class="signature-attributes">opt</span>, userCredentials<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise.&lt;<a href="EventStoreSubscription.html">EventStoreSubscription</a>>}</span></h4>
...
<span class="param-type">Promise.&lt;<a href="EventStoreSubscription.html">EventStoreSubscription</a>></span>
    ...
    <h4 class="name" id="subscribeToStreamFrom"><span class="type-signature"></span>subscribeToStreamFrom<span class="signature">(stream<span class="signature-attributes">non-null</span>, lastCheckpoint, resolveLinkTos<span class="signature-attributes">non-null</span>, eventAppeared<span class="signature-attributes">non-null</span>, liveProcessingStarted<span class="signature-attributes">opt</span>, subscriptionDropped<span class="signature-attributes">opt</span>, userCredentials<span class="signature-attributes">opt</span>, readBatchSize<span class="signature-attributes">opt, non-null</span>)</span><span class="type-signature"> &rarr; {EventStoreStreamCatchUpSubscription}</span></h4>
...
<span class="param-type">EventStoreStreamCatchUpSubscription</span>
    ...
    <h4 class="name" id="updatePersistentSubscription"><span class="type-signature"></span>updatePersistentSubscription<span class="signature">(stream, groupName, settings, userCredentials<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Promise.&lt;<a href="PersistentSubscriptionUpdateResult.html">PersistentSubscriptionUpdateResult</a>>}</span></h4>
