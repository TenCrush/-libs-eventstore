...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: DeleteResult</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: DeleteResult</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>DeleteResult<span class="signature">(logPosition)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="DeleteResult"><span class="type-signature"></span>new DeleteResult<span class="signature">(logPosition)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="results.js.html">results.js</a>, <a href="results.js.html#line184">line 184</a>
    </li></ul></dd>
