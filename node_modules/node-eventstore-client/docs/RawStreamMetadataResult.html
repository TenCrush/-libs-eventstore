...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: RawStreamMetadataResult</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: RawStreamMetadataResult</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>RawStreamMetadataResult<span class="signature">(stream, isStreamDeleted, metastreamVersion, streamMetadata)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="RawStreamMetadataResult"><span class="type-signature"></span>new RawStreamMetadataResult<span class="signature">(stream, isStreamDeleted, metastreamVersion, streamMetadata)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
        ...
        <tr>
                ...
                <td class="name"><code>isStreamDeleted</code></td>
...
<span class="param-type">boolean</span>
        ...
        <tr>
                ...
                <td class="name"><code>metastreamVersion</code></td>
...
<span class="param-type">Long</span>
        ...
        <tr>
                ...
                <td class="name"><code>streamMetadata</code></td>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="results.js.html">results.js</a>, <a href="results.js.html#line200">line 200</a>
    </li></ul></dd>
