...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: EventStoreCatchUpSubscription</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: EventStoreCatchUpSubscription</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>EventStoreCatchUpSubscription<span class="signature">(connection, log, streamId, resolveLinkTos, userCredentials, eventAppeared, liveProcessingStarted, subscriptionDropped, verboseLogging, readBatchSize, maxPushQueueSize)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="EventStoreCatchUpSubscription"><span class="type-signature"></span>new EventStoreCatchUpSubscription<span class="signature">(connection, log, streamId, resolveLinkTos, userCredentials, eventAppeared, liveProcessingStarted, subscriptionDropped, verboseLogging, readBatchSize, maxPushQueueSize)</span><span class="type-signature"></span></h4>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>maxPushQueueSize</code></td>
...
<table class="props">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>isSubscribedToAll</code></td>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="eventStoreCatchUpSubscription.js.html">eventStoreCatchUpSubscription.js</a>, <a href="eventStoreCatchUpSubscription.js.html#line29">line 29</a>
    </li></ul></dd>
