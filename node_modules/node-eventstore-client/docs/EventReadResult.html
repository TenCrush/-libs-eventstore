...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: EventReadResult</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: EventReadResult</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>EventReadResult<span class="signature">(status, stream, eventNumber, event)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="EventReadResult"><span class="type-signature"></span>new EventReadResult<span class="signature">(status, stream, eventNumber, event)</span><span class="type-signature"></span></h4>
...
<span class="param-type"><a href="ResolvedEvent.html">ResolvedEvent</a></span>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="results.js.html">results.js</a>, <a href="results.js.html#line105">line 105</a>
    </li></ul></dd>
