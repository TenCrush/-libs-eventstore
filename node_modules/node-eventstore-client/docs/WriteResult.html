...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: WriteResult</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: WriteResult</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>WriteResult<span class="signature">(nextExpectedVersion, logPosition)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="WriteResult"><span class="type-signature"></span>new WriteResult<span class="signature">(nextExpectedVersion, logPosition)</span><span class="type-signature"></span></h4>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>nextExpectedVersion</code></td>
...
<span class="param-type">number</span>
        ...
        <tr>
                ...
                <td class="name"><code>logPosition</code></td>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="results.js.html">results.js</a>, <a href="results.js.html#line120">line 120</a>
    </li></ul></dd>
