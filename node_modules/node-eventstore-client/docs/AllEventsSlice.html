...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: AllEventsSlice</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: AllEventsSlice</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>AllEventsSlice<span class="signature">(readDirection, fromPosition, nextPosition, events)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="AllEventsSlice"><span class="type-signature"></span>new AllEventsSlice<span class="signature">(readDirection, fromPosition, nextPosition, events)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
        ...
        <tr>
                ...
                <td class="name"><code>fromPosition</code></td>
...
<span class="param-type"><a href="Position.html">Position</a></span>
        ...
        <tr>
                ...
                <td class="name"><code>nextPosition</code></td>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="results.js.html">results.js</a>, <a href="results.js.html#line170">line 170</a>
    </li></ul></dd>
