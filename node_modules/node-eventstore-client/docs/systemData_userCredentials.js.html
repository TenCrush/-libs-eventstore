...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: systemData/userCredentials.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: systemData/userCredentials.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>var ensure = require('../common/utils/ensure');
...
module.exports = UserCredentials;</code></pre>
        </article>
    </section>
