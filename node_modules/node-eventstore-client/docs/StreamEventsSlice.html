...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: StreamEventsSlice</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: StreamEventsSlice</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>StreamEventsSlice<span class="signature">(status, stream, fromEventNumber, readDirection, events, nextEventNumber, lastEventNumber, isEndOfStream)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="StreamEventsSlice"><span class="type-signature"></span>new StreamEventsSlice<span class="signature">(status, stream, fromEventNumber, readDirection, events, nextEventNumber, lastEventNumber, isEndOfStream)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
        ...
        <tr>
                ...
                <td class="name"><code>fromEventNumber</code></td>
...
<span class="param-type">Long</span>
        ...
        <tr>
                ...
                <td class="name"><code>readDirection</code></td>
...
<span class="param-type">Array.&lt;<a href="ResolvedEvent.html">ResolvedEvent</a>></span>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="results.js.html">results.js</a>, <a href="results.js.html#line145">line 145</a>
    </li></ul></dd>
