...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: PersistentSubscriptionDeleteResult</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: PersistentSubscriptionDeleteResult</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>PersistentSubscriptionDeleteResult<span class="signature">(status)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="PersistentSubscriptionDeleteResult"><span class="type-signature"></span>new PersistentSubscriptionDeleteResult<span class="signature">(status)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="results.js.html">results.js</a>, <a href="results.js.html#line252">line 252</a>
    </li></ul></dd>
